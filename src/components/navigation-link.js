  ...
  return (
    ...
    >
      ...
      {shortcutNumber && (
        <span
          className={cn(
            'grid opacity-0 transition-opacity duration-500 ease-in-out group-hover/nav:opacity-100 h-5 w-5 place-content-center rounded border border-gray-200 bg-gray-100 text-xs font-medium text-gray-500 group-hover:border-gray-300',
